package com.nishankswamy.weatherapp.url;
...
public class URL {
    ...
    public URL() {
        link = "https://openweathermap.org/data/2.5/onecall?exclude=minutely&lat="
    ...
    public static void setCity_url(String cityName) {
        city_url = "https://openweathermap.org/data/2.5/weather?&q=" + cityName + "&appid=" + LocationCord.API_KEY;
    }
